import { Settings, User, Mail, Lock, Building2, Phone, Briefcase, ArrowLeft } from 'lucide-react';
        ...
        <div className="bg-[#1e2836]/80 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-white/10">
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center space-y-4">
              ...
              <h4 className="text-white font-semibold text-lg">¡Registro Exitoso!</h4>
              <p className="text-gray-400 text-sm">Su cuenta ha sido creada correctamente en el sistema.</p>

              <div className="bg-cyan-500/10 border border-cyan-400/30 rounded-lg p-4 mt-4">
                <p className="text-cyan-400 text-sm font-semibold mb-2">Credenciales de Acceso</p>
                <p className="text-gray-400 text-xs mb-1">
                  Usuario: <span className="text-white font-mono">{formData.username}</span>
                </p>
                <p className="text-gray-400 text-xs">
                  Ya puede utilizar su correo electrónico <span className="text-cyan-400">{formData.email}</span> para iniciar sesión.
                </p>
              </div>
